def make_card():
  ...
  <style>
    ...
    .badge-title { font-family: ui-monospace, SFMono-Regular, "SF Mono", Menlo, Consolas, monospace; font-size: 14px; fill: #38bdf8; font-weight: bold; }
    .badge-sub { font-family: ui-monospace, SFMono-Regular, "SF Mono", Menlo, Consolas, monospace; font-size: 10px; fill: #c084fc; font-weight: bold; }
  ...
  <!-- Header Title -->
  <text x="350" y="21" text-anchor="middle" class="header-text">1GabsFps@workstation:~ (zsh)</text>

  <!-- Left Column: Tech Stack Monogram Badge -->
  <g transform="translate(25, 65)">
    <!-- Neon Icon Box -->
    <rect x="0" y="0" width="130" height="270" rx="8" ry="8" fill="#130c2a" stroke="#4c1d95" stroke-width="1" />
    
    <!-- Code Monogram -->
    <text x="65" y="38" text-anchor="middle" class="badge-title">&lt;DEV/&gt;</text>
    <text x="65" y="58" text-anchor="middle" class="badge-sub">FULLSTACK</text>
    <text x="65" y="74" text-anchor="middle" font-family="monospace" font-size="9" fill="#94a3b8">ENGINEER</text>
    
    <text x="65" y="105" text-anchor="middle" font-family="monospace" font-size="10" fill="#a855f7">════════════</text>
    <text x="65" y="126" text-anchor="middle" font-family="monospace" font-size="11" fill="#38bdf8" font-weight="bold">🐍 PYTHON</text>
    <text x="65" y="148" text-anchor="middle" font-family="monospace" font-size="11" fill="#c084fc" font-weight="bold">⚛️ REACT</text>
    <text x="65" y="170" text-anchor="middle" font-family="monospace" font-size="11" fill="#38bdf8" font-weight="bold">☁️ AZURE</text>
    <text x="65" y="192" text-anchor="middle" font-family="monospace" font-size="11" fill="#f472b6" font-weight="bold">📡 IOT/NFC</text>
    <text x="65" y="214" text-anchor="middle" font-family="monospace" font-size="10" fill="#a855f7">════════════</text>
    
    <text x="65" y="238" text-anchor="middle" font-family="monospace" font-size="9" fill="#94a3b8">v2.4.0</text>
    <text x="65" y="254" text-anchor="middle" font-family="monospace" font-size="9" fill="#64748b">x86_64 Linux</text>
  </g>
  ...
  <g transform="translate(175, 60)">
    ...
    <g class="line" style="animation-delay: 0.05s;">
      <text x="0" y="12" class="user-title">
        <tspan fill="#38bdf8">1GabsFps</tspan><tspan fill="#a855f7">@</tspan><tspan fill="#c084fc">workstation</tspan>
      </text>
      <!-- Neon Underline -->
    ...
    <!-- Terminal Color Palette Circles -->
